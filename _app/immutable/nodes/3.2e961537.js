import{s as Le,f as a,a as l,l as Z,A as Se,g as i,d as t,c as r,h as q,m as ee,B as g,j as d,C as De,k as c,x as o,i as n,y as he,z as Ne}from"../chunks/scheduler.cd38125d.js";import{S as Ve,i as je}from"../chunks/index.a6a2bf8f.js";/* empty css                    */import{p as Be}from"../chunks/stores.bd414364.js";function Fe(p){let m,S,u,G,T,x,ge,te,I,se,ae,C,ie,oe,E,ne,le,O,re,F,H,pe="Documentation",R,D,fe=`<h3>Citation</h3> <div><p><i>Koopmans, F. (2024). GOAT: efficient and robust identification of gene set enrichment.
				Communications Biology, 7(1), 744.</i> <br/> <a href="https://doi.org/10.1038/s42003-024-06454-5" target="_blank" rel="nofollow">https://doi.org/10.1038/s42003-024-06454-5
			</a>.
			<a href="https://pubmed.ncbi.nlm.nih.gov/38898151" target="_blank" rel="nofollow">PMID: 38898151</a></p></div>`,P,_,me=`<h3>How do I use this tool?</h3> <div><div>Overview of the GOAT online workflow</div> <div><ol><li class="svelte-pooqga">Input data: the gene list, this is the dataset you want to analyze. Typically a table of
					...
					database)</li> <li class="svelte-pooqga">Optionally, adjust the GOAT online settings</li> <li class="svelte-pooqga">run the analysis by clicking &quot;START&quot; (&quot;GOAT analysis&quot; section of the tool)</li> <li class="svelte-pooqga">Download results; an Excel table with all gene set statistics &amp; text file with a
					Methods description for your paper. <br/>See the
				...
				with p-value=1).</li></ul></div> <div style="margin-bottom: 20px;"><b>importantly</b>, only Human Entrez (NCBI) gene IDs are supported for now (i.e. values in the
		&#39;gene&#39; column).
		<br/>
		...
		GOAT.</div>`,K,b,be=`<h3>Using a custom gene set database</h3> <p>A gene set database prepared in the generic GMT file format can be easily imported into this
		tool. Any compatible GMT file that is stored on your computer can be used with GOAT online by
		using the &quot;upload GMT file&quot; button in the &quot;Gene sets&quot; section of the GOAT online tool.</p> <p>GOAT online only works when the input gene list and gene set database use Entrez Gene
		...
		<ul><li class="svelte-pooqga">KEGG_MEDICUS: Canonical Pathways gene sets derived from the KEGG MEDICUS pathway database</li> <li class="svelte-pooqga">HPO: Gene sets derived from the Human Phenotype ontology</li> <li class="svelte-pooqga">CP: Canonical pathways. For example, the downloaded file would have a name similar to
				...
				transcription factors or microRNAs</li></ul></div>`,U,y,ye=`<h3>GOAT online output files</h3> <p>After the GOAT analysis is done, you can download the results from the &quot;Result summary&quot; section
		of the GOAT online tool.</p> <p>The downloaded ZIP file contains a plain text file that details the exact settings used in GOAT
		...
		significant Gene Ontology terms as compared to alternative methods.`,de,B,j,Ge,ce,L,Te=`<ol><li class="svelte-pooqga">Required input is a list of genes and their respective test statistics (p-value/effect
				...
				respective gene scores) against a null distribution of the same size (N).</li></ol>`,$,A,xe=`<h3>Frequently Asked Questions (FAQ)</h3> <p><i>What if I want to obtain the significant gene sets that also contain at least N &quot;significant
		...
		package are the same across all OMICS-based datasets that are described in the GOAT manuscript.</p>`,J,z,Oe='<h3>Privacy</h3> <ul><li class="svelte-pooqga">all analyses are performed locally on your computer using client-side Javascript code</li> <li class="svelte-pooqga">your gene list and all analyses thereof remain private; your data does not leave your computer</li> <li class="svelte-pooqga">we do count the number of times this tool is used, anonymously, to gauge its popularity</li></ul>',Q,M,_e=`<h3>Logo</h3> <p>the GOAT logo shown on this website is borrowed from the open-source Noto Emoji Font version
		14.0</p>`,X,w,Ae=`<h3>Glossary</h3> <div><ul><li class="svelte-pooqga">GOAT: Gene set Ordinal Association Test. A parameter-free algorithm for gene set enrichment
				...
				results from GOAT include ready-made text that can be used for this.</li></ul></div>`;return{c(){m=a("meta"),S=l(),u=a("nav"),G=a("div"),T=a("a"),x=a("img"),te=l(),I=a("a"),se=Z("Home"),ae=l(),C=a("a"),ie=Z("GOAT online"),oe=l(),E=a("a"),ne=Z("gene ID mapping"),le=l(),O=a("a"),re=Z("Documentation"),F=l(),H=a("h1"),H.textContent=pe,R=l(),D=a("div"),D.innerHTML=fe,P=l(),_=a("div"),_.innerHTML=me,W=l(),v=a("div"),v.innerHTML=ve,K=l(),b=a("div"),b.innerHTML=be,U=l(),y=a("div"),y.innerHTML=ye,Y=l(),h=a("div"),N=a("h3"),N.textContent=we,ue=l(),V=a("p"),V.textContent=qe,de=l(),B=a("div"),j=a("img"),ce=l(),L=a("div"),L.innerHTML=Te,$=l(),A=a("div"),A.innerHTML=xe,J=l(),z=a("div"),z.innerHTML=Oe,Q=l(),M=a("div"),M.innerHTML=_e,X=l(),w=a("div"),w.innerHTML=Ae,this.h()},l(e){const s=Se("svelte-1nmuhnx",document.head);m=i(s,"META",{name:!0,content:!0}),s.forEach(t),S=r(e),u=i(e,"NAV",{});var f=q(u);G=i(f,"DIV",{style:!0});var ze=q(G);T=i(ze,"A",{href:!0});var Me=q(T);x=i(Me,"IMG",{src:!0,width:!0,height:!0,alt:!0}),Me.forEach(t),ze.forEach(t),te=r(f),I=i(f,"A",{href:!0,style:!0});var ke=q(I);se=ee(ke,"Home"),ke.forEach(t),ae=r(f),C=i(f,"A",{href:!0,style:!0});var Ie=q(C);ie=ee(Ie,"GOAT online"),Ie.forEach(t),oe=r(f),E=i(f,"A",{href:!0,style:!0});var Ce=q(E);ne=ee(Ce,"gene ID mapping"),Ce.forEach(t),le=r(f),O=i(f,"A",{href:!0,style:!0,class:!0});var Ee=q(O);re=ee(Ee,"Documentation"),Ee.forEach(t),f.forEach(t),F=r(e),H=i(e,"H1",{"data-svelte-h":!0}),g(H)!=="svelte-fjilyk"&&(H.textContent=pe),R=r(e),D=i(e,"DIV",{"data-svelte-h":!0}),g(D)!=="svelte-1dniuav"&&(D.innerHTML=fe),P=r(e),_=i(e,"DIV",{style:!0,"data-svelte-h":!0}),g(_)!=="svelte-2p5ilx"&&(_.innerHTML=me),W=r(e),v=i(e,"DIV",{id:!0,style:!0,"data-svelte-h":!0}),g(v)!=="svelte-1l2zn4y"&&(v.innerHTML=ve),K=r(e),b=i(e,"DIV",{id:!0,style:!0,"data-svelte-h":!0}),g(b)!=="svelte-16cve12"&&(b.innerHTML=be),U=r(e),y=i(e,"DIV",{id:!0,style:!0,"data-svelte-h":!0}),g(y)!=="svelte-skx7cm"&&(y.innerHTML=ye),Y=r(e),h=i(e,"DIV",{style:!0});var k=q(h);N=i(k,"H3",{"data-svelte-h":!0}),g(N)!=="svelte-1xztreg"&&(N.textContent=we),ue=r(k),V=i(k,"P",{"data-svelte-h":!0}),g(V)!=="svelte-18t7lzs"&&(V.textContent=qe),de=r(k),B=i(k,"DIV",{});var He=q(B);j=i(He,"IMG",{src:!0,alt:!0}),He.forEach(t),ce=r(k),L=i(k,"DIV",{style:!0,"data-svelte-h":!0}),g(L)!=="svelte-n2xzyy"&&(L.innerHTML=Te),k.forEach(t),$=r(e),A=i(e,"DIV",{style:!0,"data-svelte-h":!0}),g(A)!=="svelte-qivsl0"&&(A.innerHTML=xe),J=r(e),z=i(e,"DIV",{style:!0,"data-svelte-h":!0}),g(z)!=="svelte-ro74ze"&&(z.innerHTML=Oe),Q=r(e),M=i(e,"DIV",{style:!0,"data-svelte-h":!0}),g(M)!=="svelte-curqo9"&&(M.innerHTML=_e),X=r(e),w=i(e,"DIV",{id:!0,style:!0,"data-svelte-h":!0}),g(w)!=="svelte-1tkaa5a"&&(w.innerHTML=Ae),this.h()},h(){document.title="GOAT: Gene set Ordinal Association Test - documentation",d(m,"name","description"),d(m,"content","Gene set enrichment analysis for Gene Ontology (GO) or KEGG pathways using the GOAT algorithm web tool. Online data analysis for your preranked gene list from e.g. proteomics or bulk/scRNAseq gene expression studies"),De(x.src,ge=p[0]+"android-chrome-192x192.png")||d(x,"src",ge),d(x,"width","40"),d(x,"height","40"),d(x,"alt","GOAT"),d(T,"href",p[0]),c(G,"padding","4px"),c(G,"margin-left","20px"),d(I,"href",p[0]),c(I,"margin-left","5px"),d(C,"href",p[0]+"goat"),c(C,"margin-left","40px"),d(E,"href",p[0]+"genemap"),c(E,"margin-left","40px"),d(O,"href",p[0]+"docs"),c(O,"margin-left","40px"),d(O,"class","active"),c(_,"margin-top","50px"),d(v,"id","genelist"),c(v,"margin-top","50px"),d(b,"id","GMTgenesets"),c(b,"margin-top","50px"),d(y,"id","GOATresults"),c(y,"margin-top","50px"),De(j.src,Ge=p[0]+"goat_algorithm.png")||d(j,"src",Ge),d(j,"alt","GOAT algorithm"),c(L,"padding","0px 50px 0px 10px"),c(h,"margin-top","50px"),c(A,"margin-top","50px"),c(z,"margin-top","50px"),c(M,"margin-top","50px"),d(w,"id","Glossary"),c(w,"margin-top","50px")},m(e,s){o(document.head,m),n(e,S,s),n(e,u,s),o(u,G),o(G,T),o(T,x),o(u,te),o(u,I),o(I,se),o(u,ae),o(u,C),o(C,ie),o(u,oe),o(u,E),o(E,ne),o(u,le),o(u,O),o(O,re),n(e,F,s),n(e,H,s),n(e,R,s),n(e,D,s),n(e,P,s),n(e,_,s),n(e,W,s),n(e,v,s),n(e,K,s),n(e,b,s),n(e,U,s),n(e,y,s),n(e,Y,s),n(e,h,s),o(h,N),o(h,ue),o(h,V),o(h,de),o(h,B),o(B,j),o(h,ce),o(h,L),n(e,$,s),n(e,A,s),n(e,J,s),n(e,z,s),n(e,Q,s),n(e,M,s),n(e,X,s),n(e,w,s)},p:he,i:he,o:he,d(e){e&&(t(S),t(u),t(F),t(H),t(R),t(D),t(P),t(_),t(W),t(v),t(K),t(b),t(U),t(y),t(Y),t(h),t($),t(A),t(J),t(z),t(Q),t(M),t(X),t(w)),t(m)}}}function Re(p,m,S){let u;return Ne(p,Be,T=>S(1,u=T)),[!!u&&u.url.hostname.endsWith("github.io")&&"/goat/"||"/"]}class Ye extends Ve{constructor(m){super(),je(this,m,Re,Fe,Le,{})}}export{Ye as component};
